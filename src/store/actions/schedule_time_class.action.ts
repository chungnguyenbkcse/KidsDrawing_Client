...
export function removeScheduleTimeClass(id: number): IRemoveScheduleTimeClassActionType {
...
interface IRemoveScheduleTimeClassActionType { type: string, id: number };
