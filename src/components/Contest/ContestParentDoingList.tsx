...
function ContestParentDoingList(props: lessonListProps): JSX.Element {
    ...
    useEffect(() => {
        let x = (contest_parents.contest_opening.length - contest_parents.contest_opening.length % 10) /10;
        if (x === 0) {
            setElement(contest_parents.contest_opening)
        }
        else {
            setElement(contest_parents.contest_opening.slice(0,10))
        }
        
         setTotalPage((x+1))
    }, [contest_parents.contest_opening])
    ...
    function handlePagination(count: number) {
        console.log(count)
        if (count === totalPage) {
            setElement(contest_parents.contest_opening.slice(count*10))
        }
        else {
            setElement(contest_parents.contest_opening.slice(count*10,count*10 + 10))
        }
    }
    ...
    function handleFilter() {
        if (filter2 == 0) {
            if (filter == 0 && filter1 == 0) {
                let k = contest_parents.contest_opening;
                ...
                let k = contest_parents.contest_opening.filter((ele, idx) => ele.art_age_id == filter1)
                ...
                let k = contest_parents.contest_opening.filter((ele, idx) => ele.art_type_id == filter)
                ...
                let k = contest_parents.contest_opening.filter((ele, idx) => ele.art_type_id == filter && ele.art_age_id == filter1)
            ...
            if (filter == 0 && filter1 == 0) {
                let k = contest_parents.contest_opening.filter((ele, idx) => ele.student_id == filter2);
                ...
                let k = contest_parents.contest_opening.filter((ele, idx) => ele.art_age_id == filter1 && ele.student_id == filter2)
                ...
                let k = contest_parents.contest_opening.filter((ele, idx) => ele.art_type_id == filter && ele.student_id == filter2)
                ...
                let k = contest_parents.contest_opening.filter((ele, idx) => ele.art_type_id == filter && ele.art_age_id == filter1 && ele.student_id == filter2)
...
export default ContestParentDoingList;
