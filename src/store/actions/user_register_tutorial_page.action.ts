...
export function removeUserRegisterTutorialPage(id: number): IRemoveUserRegisterTutorialPageActionType {
...
interface IRemoveUserRegisterTutorialPageActionType { type: string, id: number };
