...
function RequestOffSectionForm(props: artAgeListProps): JSX.Element {
    ...
    if (isCreate){
        ...
        student_leave = { id: 0, section_id: section_id, class_id: classes_id, section_number: section_number, student_id: student_id, description: resson, section_name: "", class_name: "", student_name: student_name, reviewer_id: 0, status: "", create_time: "", update_time: "" }
    }
