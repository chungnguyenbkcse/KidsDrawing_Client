        ...
        if (access_token !== null && refresh_token !== null && access_token !== undefined && refresh_token !== undefined) {
            ...
            if (exp_access_token_decode < now_time) {
                if (exp_refresh_token_decode < now_time) {
                    ...
                    trackPromise(getContestSubmissionByContestAndStudent(dispatch, contest_id, id))
                }
            }
            else {
                trackPromise(getContestSubmissionByContestAndStudent(dispatch, contest_id, id))
                            ...
                            <div className="col-xl-12 col-md-12 mb-4">
                                <div className={`card shadow h-100 py-2`} id="normal-tutorial">
                                    <div className="card-body">
                                        ...
                                        <div className="row no-gutters">
                                            <p id="phone">Số người tham gia tối đa: {max_participant}</p>
                                        </div>
                    ...
                    <div className="card-body mx-auto">
                        {
                            function () {
                                return (
                                    <PhotoProvider>
                                        <PhotoView src={(preview === null || preview === "") ? url_contest_submission : preview}>
                                            <img src={(preview === null || preview === "") ? url_contest_submission : preview} alt="" className="center-x" />
                                        </PhotoView>
                                    </PhotoProvider>
                                )
                            }()
