...
// Not approved
export const REMOVE_TEACHER_REGISTER_QUANTIFICATION_NOT_APPROVED_ALL: string = "REMOVE_TEACHER_REGISTER_QUANTIFICATION_APPROVED_ALL";
export const INITIAL_TEACHER_REGISTER_QUANTIFICATION_NOT_APPROVED: string = "INITIAL_TEACHER_REGISTER_QUANTIFICATION_APPROVED";
export const ADD_TEACHER_REGISTER_QUANTIFICATION_NOT_APPROVED: string = "ADD_TEACHER_REGISTER_QUANTIFICATION_APPROVED";
export const EDIT_TEACHER_REGISTER_QUANTIFICATION_NOT_APPROVED: string = "EDIT_TEACHER_REGISTER_QUANTIFICATION_APPROVED";
export const REMOVE_TEACHER_REGISTER_QUANTIFICATION_NOT_APPROVED: string = "REMOVE_TEACHER_REGISTER_QUANTIFICATION_APPROVED";
export const CHANGE_TEACHER_REGISTER_QUANTIFICATION_AMOUNT_NOT_APPROVED: string = "CHANGE_TEACHER_REGISTER_QUANTIFICATION_AMOUNT_APPROVED";
export const CHANGE_TEACHER_REGISTER_QUANTIFICATION_NOT_APPROVED_PENDING_EDIT: string = "CHANGE_TEACHER_REGISTER_QUANTIFICATION_APPROVED_PENDING_EDIT";
export const CLEAR_TEACHER_REGISTER_QUANTIFICATION_NOT_APPROVED_PENDING_EDIT: string = "CLEAR_TEACHER_REGISTER_QUANTIFICATION_APPROVED_PENDING_EDIT";

// Not approved now
export const REMOVE_TEACHER_REGISTER_QUANTIFICATION_NOT_APPROVED_NOW_ALL: string = "REMOVE_TEACHER_REGISTER_QUANTIFICATION_APPROVED_ALL";
export const INITIAL_TEACHER_REGISTER_QUANTIFICATION_NOT_APPROVED_NOW: string = "INITIAL_TEACHER_REGISTER_QUANTIFICATION_APPROVED";
export const ADD_TEACHER_REGISTER_QUANTIFICATION_NOT_APPROVED_NOW: string = "ADD_TEACHER_REGISTER_QUANTIFICATION_APPROVED";
export const EDIT_TEACHER_REGISTER_QUANTIFICATION_NOT_APPROVED_NOW: string = "EDIT_TEACHER_REGISTER_QUANTIFICATION_APPROVED";
export const REMOVE_TEACHER_REGISTER_QUANTIFICATION_NOT_APPROVED_NOW: string = "REMOVE_TEACHER_REGISTER_QUANTIFICATION_APPROVED";
export const CHANGE_TEACHER_REGISTER_QUANTIFICATION_AMOUNT_NOT_APPROVED_NOW: string = "CHANGE_TEACHER_REGISTER_QUANTIFICATION_AMOUNT_APPROVED";
export const CHANGE_TEACHER_REGISTER_QUANTIFICATION_NOT_APPROVED_NOW_PENDING_EDIT: string = "CHANGE_TEACHER_REGISTER_QUANTIFICATION_APPROVED_PENDING_EDIT";
export const CLEAR_TEACHER_REGISTER_QUANTIFICATION_NOT_APPROVED_NOW_PENDING_EDIT: string = "CLEAR_TEACHER_REGISTER_QUANTIFICATION_APPROVED_PENDING_EDIT";
