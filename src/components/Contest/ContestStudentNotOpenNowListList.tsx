...
function ContestStudentNotOpenNowList(props: lessonListProps): JSX.Element {
    ...
    function handleFilter() {
        if (filter == 0 && filter1 == 0) {
            ...
            let k = contest_students.contest_not_open_now.filter((ele, idx) => ele.art_age_id == filter1)
            ...
            let k = contest_students.contest_not_open_now.filter((ele, idx) => ele.art_type_id == filter)
            ...
            let k = contest_students.contest_not_open_now.filter((ele, idx) => ele.art_type_id == filter && ele.art_age_id == filter1)
