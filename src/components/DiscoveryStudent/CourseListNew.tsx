...
function CourseListNew(props: semesterListProps): JSX.Element {
    ...
    function handleFilter() {
        ...
        if (filter == 0 && filter1 == 0 && filter2 == 0) {
            ...
            let k = course_news.course_news.filter((ele, idx) =>  ele.art_level_id == filter2)
            ...
            let k = course_news.course_news.filter((ele, idx) =>  ele.art_age_id == filter1)
            ...
            let k = course_news.course_news.filter((ele, idx) =>  ele.art_type_id == filter)
            ...
            let k = course_news.course_news.filter((ele, idx) =>  ele.art_type_id == filter && ele.art_age_id == filter1)
            ...
            let k = course_news.course_news.filter((ele, idx) =>  ele.art_level_id == filter2 && ele.art_age_id == filter1)
            ...
            let k = course_news.course_news.filter((ele, idx) =>  ele.art_level_id == filter2 && ele.art_type_id == filter)
            ...
            let k = course_news.course_news.filter((ele, idx) =>  ele.art_level_id == filter2 && ele.art_type_id == filter && ele.art_age_id  == filter1)
