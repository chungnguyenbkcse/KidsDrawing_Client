...
export function removeUserReadedNotification(id: number): IRemoveUserReadedNotificationActionType {
...
export function removeUserNotReadedNotification(id: number): IRemoveUserNotReadedNotificationActionType {
...
interface IRemoveUserReadedNotificationActionType { type: string, id: number };
...
interface IRemoveUserNotReadedNotificationActionType { type: string, id: number };
