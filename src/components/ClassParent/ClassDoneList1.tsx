    ...
    function handleFilter() {
        ...
        if (filter3 == 0) {
            if (filter == 0 && filter1 == 0 && filter2 == 0) {
                let k = classes_parents.classes_done;
                ...
                let k = classes_parents.classes_done.filter((ele, idx) => ele.art_level_id == filter2)
                ...
                let k = classes_parents.classes_done.filter((ele, idx) => ele.art_age_id == filter1)
                ...
                let k = classes_parents.classes_done.filter((ele, idx) => ele.art_type_id == filter)
                ...
                let k = classes_parents.classes_done.filter((ele, idx) => ele.art_type_id == filter && ele.art_age_id == filter1)
                ...
                let k = classes_parents.classes_done.filter((ele, idx) => ele.art_level_id == filter2 && ele.art_age_id == filter1)
                ...
                let k = classes_parents.classes_done.filter((ele, idx) => ele.art_level_id == filter2 && ele.art_type_id == filter)
                ...
                let k = classes_parents.classes_done.filter((ele, idx) => ele.art_level_id == filter2 && ele.art_type_id == filter && ele.art_age_id == filter1)
            ...
            if (filter == 0 && filter1 == 0 && filter2 == 0) {
                let k = classes_parents.classes_done.filter((ele, idx) => ele.student_id == filter3)
                ...
                let k = classes_parents.classes_done.filter((ele, idx) => ele.art_level_id == filter2 && ele.student_id == filter3)
                ...
                let k = classes_parents.classes_done.filter((ele, idx) => ele.art_age_id == filter1 && ele.student_id == filter3)
                ...
                let k = classes_parents.classes_done.filter((ele, idx) => ele.art_type_id == filter && ele.student_id == filter3)
                ...
                let k = classes_parents.classes_done.filter((ele, idx) => ele.art_type_id == filter && ele.art_age_id == filter1 && ele.student_id == filter3)
                ...
                let k = classes_parents.classes_done.filter((ele, idx) => ele.art_level_id == filter2 && ele.art_age_id == filter1 && ele.student_id == filter3)
                ...
                let k = classes_parents.classes_done.filter((ele, idx) => ele.art_level_id == filter2 && ele.art_type_id == filter && ele.student_id == filter3)
                ...
                let k = classes_parents.classes_done.filter((ele, idx) => ele.art_level_id == filter2 && ele.art_type_id == filter && ele.art_age_id == filter1 && ele.student_id == filter3)
                                ...
                                return (
                                    <div className="col-md-4" onClick={() => { routeChange(ele) }}>
                                        <div className="p-card bg-white p-2 rounded px-3 product-x">
                                            ...
                                            <span className="d-block mb-2">Đã học {ele.total_section}/{ele.total_section} buổi.</span>
                                            <div
