...
import SemesterClassNewTeacherList from "./SemesterClassNewTeacherList";

const SemesterClassNewTeacher: React.FC = () => {
    ...
    return (
        promiseInProgress ?
            <div className="loader"></div> : <Fragment>
                ...
                <div className="row">
                    <SemesterClassNewTeacherList value={searchTerm} />
                </div>
        </Fragment>
    )
...
export default SemesterClassNewTeacher;
