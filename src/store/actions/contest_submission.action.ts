...
export function removeContestNotGraded(id: number): IRemoveContestNotGradedActionType {
...
export function removeContestGraded(id: number): IRemoveContestGradedActionType {
...
interface IRemoveContestNotGradedActionType { type: string, id: number };
...
interface IRemoveContestGradedActionType { type: string, id: number };
