...
export function removeAnonymousNotification(id: number): IRemoveAnonymousNotificationActionType {
...
interface IRemoveAnonymousNotificationActionType { type: string, id: number };
