...
const Schedule: React.FC = () => {
    ...
    return (
        <Fragment>
            ...
            <div className="row">
                <TopCard title="SỐ LỊCH HỌC" text={`${numberItemsCount}`} icon="box" class="primary" />
            </div>
            ...
            >
                <div className="row text-left">
                    {((products.modificationState === ProductModificationStatus.Create) || (products.modificationState === ProductModificationStatus.Edit && products.selectedProduct)) ? <ScheduleForm /> : null}
                </div>
            </Popup>
        </Fragment >
    );
