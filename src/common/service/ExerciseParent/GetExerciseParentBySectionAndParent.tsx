...
export function getExerciseForSectionAndParent(dispatch: any, section_id: number, parent_id: number) {
            ...
            .then( response => {
                if (!response.ok) {
                    if (response.status === 403) {
                        ...
                        dispatch(getExerciseForSectionAndParent(dispatch, section_id, parent_id))
                    }
                    else {
