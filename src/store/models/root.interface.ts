...
export interface IChildsClassState {
    selectedChildsClass: IChildsClass | null;
    modificationState: ChildsClassModificationStatus;
    childs_class: IChildsClass[];
}
...
export interface IChildState {
    ...
    modificationState: ChildModificationStatus;
    childs: IChild[];
}

export interface IFinalScoreChildState {
    selectedFinalScoreChild: IFinalScoreChild | null;
    modificationState: FinalScoreChildModificationStatus;
    final_score_childs: IFinalScoreChild[];
}

export interface ISemesterClassTeacherState {
    selectedSemesterClassTeacher: ISemesterClassTeacher | null;
    modificationState: SemesterClassTeacherModificationStatus;
    semester_class_teachers: ISemesterClassTeacher[];
}
...
export interface ICourseTeacherNewState {
    selectedCourseTeacherNew: ICourseTeacherNew | null;
    modificationState: CourseTeacherNewModificationStatus;
    courses: ICourseTeacherNew[];
}
...
export interface IExerciseParentState {
    selectedExerciseParent: IExerciseParent | null;
    modificationState: ExerciseParentModificationStatus;
    exercise_not_submit: IExerciseParent[];
    exercise_submitted_not_grade: IExerciseParent[];
    exercise_submitted_graded: IExerciseParent[];
}
...
export interface ICourseNewState {
    selectedCourseNew: ICourseNew | null;
    modificationState: CourseNewModificationStatus;
    course_news: ICourseNew[];
}

export interface ICourseParentNewState {
    selectedCourseParentNew: ICourseParentNew | null;
    modificationState: CourseParentNewModificationStatus;
    courses: ICourseParentNew[];
}

export interface IClassHasRegisterJoinSemesterState {
    selectedClassHasRegisterJoinSemester: IClassHasRegisterJoinSemester | null;
    modificationState: ClassHasRegisterJoinSemesterModificationStatus;
    class_has_register_join_semesters: IClassHasRegisterJoinSemester[];
}
