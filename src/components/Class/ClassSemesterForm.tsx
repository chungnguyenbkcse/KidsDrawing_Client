...
function ClassSemesterForm(props: semesterClassListProps): JSX.Element {
  ...
  if (!semester_classe || isCreate) {
    semester_classe = { id: 0, total_register: 0,  is_new: false, max_participant: 0,registration_expiration_time: "", semester_name: "", course_id: 0, course_name: "", semester_id: 0, name: "", registration_time: "" };
  }
  else {
