...
export function removeUserGradeContestSubmission(id: number): IRemoveUserGradeContestSubmissionActionType {
...
interface IRemoveUserGradeContestSubmissionActionType { type: string, id: number };
