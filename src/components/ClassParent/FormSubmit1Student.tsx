...
function FormSubmit1Parent(): JSX.Element {
    ...
    var id_ix = localStorage.getItem('student_id');
    let student_id: number = 0;
    if (id_ix !== null) {
        student_id = parseInt(id_ix);
    }

    var id_iy = localStorage.getItem('student_name');
...
export default FormSubmit1Parent;
