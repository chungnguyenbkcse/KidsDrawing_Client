...
function ClassDoneList1(props: classTeacherListProps): JSX.Element {
    ...
    useEffect(() => {
        let x = (classes_students.classes_done.length - classes_students.classes_done.length % 6) / 6;
        if (x === 0) {
            setElement(classes_students.classes_done)
        }
        else {
            setElement(classes_students.classes_done.slice(0, 6))
        }
    ...
    function handlePagination(count: number) {
        console.log(count)
        if (count === totalPage) {
            setElement(classes_students.classes_done.slice(count * 6))
        }
        else {
            setElement(classes_students.classes_done.slice(count * 6, count * 6 + 6))
        }
    }
    ...
    function handleFilter() {
        ...
        if (filter == 0 && filter1 == 0 && filter2 == 0) {
            let k = classes_students.classes_done;
            ...
            let k = classes_students.classes_done.filter((ele, idx) => ele.art_level_id == filter2)
            ...
            let k = classes_students.classes_done.filter((ele, idx) => ele.art_age_id == filter1)
            ...
            let k = classes_students.classes_done.filter((ele, idx) => ele.art_type_id == filter)
            ...
            let k = classes_students.classes_done.filter((ele, idx) => ele.art_type_id == filter && ele.art_age_id == filter1)
            ...
            let k = classes_students.classes_done.filter((ele, idx) => ele.art_level_id == filter2 && ele.art_age_id == filter1)
            ...
            let k = classes_students.classes_done.filter((ele, idx) => ele.art_level_id == filter2 && ele.art_type_id == filter)
            ...
            let k = classes_students.classes_done.filter((ele, idx) => ele.art_level_id == filter2 && ele.art_type_id == filter && ele.art_age_id == filter1)
